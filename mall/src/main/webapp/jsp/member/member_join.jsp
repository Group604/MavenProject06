	...
	<div id="join_wrap">
		...
		<form name="m" method="post" action="member_join_ok.do"
			...
			<table id="join_t">
				<tr>
					<th>아이디</th>
					<td><input name="join_id" id="join_id" size="14" class="box" />
				...
				<tr>
					<th>우편번호</th>
					<td>
					<input name="join_zip" id="join_zip" size="3" maxlength="3" onclick="post_search();" />-
					<input name="join_zip2"id="join_zip2" size="3" maxlength="3" class="box" onclick="post_search();" /> 
				...
				<tr>
					...
					<td><select name="join_phone01">
						...
						maxlength="4" class="box" />- <input name="join_phone03"
						id="join_phone03" size="4" maxlength="4" class="box" /></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input name="mail_id" id="mail_id" size="14" class="box" />@
					    <input name="mail_domain" id="mail_domain" size="12" class="box" readonly/>
