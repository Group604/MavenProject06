...
<div id="del_wrap">
	...
	<form method="post" action="MemberDelOk.do" onsubmit="return del_check();">
	<table id="del_t">
	<tr>
	<th>회원아이디</th>
	<td>${id}</td>
	...
	<th>비밀번호</th>
	<td>
	<input type="password" name="member_pwd" id="del_pwd" size="14" class="box" />
	</td>
	</tr>
	<tr>
	<th>탈퇴사유</th>
	<td>
	<textarea name="member_delcont" id="del_cont" rows="8" cols="34" class="box"></textarea>
	</td>
	</tr>
	</table>
	<div id="del_menu">
